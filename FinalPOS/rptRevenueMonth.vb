...
Public Class rptRevenueMonth
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinalPOS.rptRevenueMonth.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRevenueMonth
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRevenueMonth = New rptRevenueMonth()
        rpt.Site = Me.Site
        Return rpt
    End Function
