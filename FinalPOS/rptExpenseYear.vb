...
Public Class rptExpenseYear
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinalPOS.rptExpenseYear.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptExpenseYear
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptExpenseYear = New rptExpenseYear()
        rpt.Site = Me.Site
        Return rpt
    End Function
