...
Public Class rptExpenseMonth
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinalPOS.rptExpenseMonth.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptExpenseMonth
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptExpenseMonth = New rptExpenseMonth()
        rpt.Site = Me.Site
        Return rpt
    End Function
