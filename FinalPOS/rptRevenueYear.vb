...
Public Class rptRevenueYear
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinalPOS.rptRevenueYear.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRevenueYear
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRevenueYear = New rptRevenueYear()
        rpt.Site = Me.Site
        Return rpt
    End Function
