...
Public Class rptImportDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FinalPOS.rptImportDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptImportDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImportDetail = New rptImportDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
